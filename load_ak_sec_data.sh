...
./orgchart -data "$BASE/2024-11-18/2413-25-1"  -type secretary
./orgchart -data "$BASE/2024-11-19/2413-25-2"  -type secretary
./orgchart -data "$BASE/2024-11-20/2413-25-3"  -type secretary
./orgchart -data "$BASE/2024-11-21/2413-25-4"  -type secretary
./orgchart -data "$BASE/2024-11-25/2413-25-5"  -type secretary
./orgchart -data "$BASE/2024-11-28/2413-25-6"  -type secretary
...
./orgchart -data "$BASE/2025-10-11/2460-27-2"  -type secretary
./orgchart -data "$BASE/2025-10-14/2460-27-3"  -type secretary
./orgchart -data "$BASE/2025-10-16/2460-27-4"  -type secretary
